...
class InventoryPage:
    ...
    # COMPLETADO: Redirección al carrito de compras
    def ir_al_carrito(self):
        self.driver.find_element(*self.link_carrito).click()

    # Agregá esto adentro de class InventoryPage en pages/inventory_page.py:
    def obtener_lista_nombres_productos(self):
        items = self.driver.find_elements(*self.nombres_productos)
        return [item.text for item in items]

    def obtener_lista_precios_productos(self):
        # Localizador rápido para los precios
        from selenium.webdriver.common.by import By
